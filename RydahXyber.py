...
def banner():
	clear()
	cetak(nel(f"""%s              
               *WELCOME TO RYDAH XYBER TOOL*         
         ░░░░ _______   __      __  _______    ______   __    __  __    __  __      __  _______   ________  _______ 
             /       \ /  \    /  |/       \  /      \ /  |  /  |/  |  /  |/  \    /  |/       \ /        |/       \ 
             $$$$$$$  |$$  \  /$$/ $$$$$$$  |/$$$$$$  |$$ |  $$ |$$ |  $$ |$$  \  /$$/ $$$$$$$  |$$$$$$$$/ $$$$$$$  |
             $$ |__$$ | $$  \/$$/  $$ |  $$ |$$ |__$$ |$$ |__$$ |$$  \/$$/  $$  \/$$/  $$ |__$$ |$$ |__    $$ |__$$ |
             $$    $$<   $$  $$/   $$ |  $$ |$$    $$ |$$    $$ | $$  $$<    $$  $$/   $$    $$< $$    |   $$    $$< 
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} RYDAH {k}{loop}{P}/{h}{len(id)}{H} {P}[{h}{ok}{P}] {P}[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()
